...
const content = {
  ...
  ar: {
    kicker: '03 / التنسيق',
    title: 'لما الرحلة يكون فيها أكثر من ترتيب.',
    intro: 'الطيران والسكن والتنقلات والأنشطة مرتبطة ببعض أكثر مما تبدو. نراجع المواعيد والتفاصيل مع بعض عشان يكون برنامج الرحلة مرتب كطلب واحد، مو حجوزات منفصلة عن بعض.',
    statement: 'الحجز يكون أفضل لما تكون المواعيد ماشية مع بعض.',
