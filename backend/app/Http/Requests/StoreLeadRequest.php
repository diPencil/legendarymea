...
class StoreLeadRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (!$companyId && !$contactId && !$this->input('person_name') && !$this->input('company_name')) {
                $validator->errors()->add('base', 'A lead must have at least a person name, company name, or be linked to an existing contact or company.');
            }
