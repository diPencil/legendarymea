...
export const solutionDetailCopy: Record<SolutionSlug, {
  en: { title: string; lead: string; need: string[]; handle: string[]; receive: string[]; uses: string[]; related: SolutionSlug }
  ar: { title: string; lead: string; need: string[]; handle: string[]; receive: string[]; uses: string[]; related: SolutionSlug }
}> = {
  'hotels-accommodation': { en:{title:'Hotels & Accommodation',lead:'Property options shaped by location, dates, room requirements and the purpose of the stay.',need:['Destination and dates','Room count and room types','Meal plan and location preferences','Traveler profile or rooming list'],handle:['Property review','Availability and commercial terms','Room allocation details','Confirmation follow-up'],receive:['Relevant property options','Clear room and meal terms','Confirmed accommodation details'],uses:['Corporate stays','Group room blocks','Individual business travel'],related:'transfers'}, ar:{title:'الفنادق والإقامة',lead:'خيارات سكن حسب الموقع والتواريخ والغرف وطبيعة الرحلة.',need:['الوجهة والتواريخ','عدد الغرف وأنواعها','الوجبات والموقع المفضل','بيانات المسافرين أو قائمة الغرف'],handle:['مراجعة المنشآت','التوفر والشروط التجارية','توزيع الغرف','متابعة التأكيد'],receive:['خيارات مناسبة للطلب','شروط واضحة للغرف والوجبات','تفاصيل سكن مؤكدة'],uses:['سكن الشركات','حجوزات المجموعات','سفر الأعمال الفردي'],related:'transfers'} },
  flights:{en:{title:'Flights',lead:'Air arrangements based on routing, travel dates, passenger details and timing.',need:['Departure and arrival points','Travel dates','Passenger names','Class and timing preferences'],handle:['Routing review','Schedule comparison','Passenger detail checks','Change requests where applicable'],receive:['Flight options','Fare and timing details','Confirmed itinerary'],uses:['Executive travel','Multi-city routing','Group air requests'],related:'transfers'},ar:{title:'الرحلات الجوية',lead:'ترتيبات طيران حسب خط السير والتواريخ وبيانات المسافرين والمواعيد.',need:['مدن المغادرة والوصول','تواريخ السفر','أسماء المسافرين','الدرجة والمواعيد المفضلة'],handle:['مراجعة المسار','مقارنة الجداول','تدقيق بيانات المسافرين','طلبات التعديل حسب الشروط'],receive:['خيارات الرحلات','تفاصيل السعر والمواعيد','خط سير مؤكد'],uses:['سفر التنفيذيين','رحلات متعددة المدن','طلبات طيران للمجموعات'],related:'transfers'}},
  transfers:{en:{title:'Transfers',lead:'Ground movements tied to flight times, pickup points, passenger numbers and vehicle requirements.',need:['Flight number and arrival time','Pickup and drop-off points','Passenger and luggage count','Vehicle or accessibility needs'],handle:['Driver and vehicle coordination','Airport timing','Multi-stop planning','Group movement sequence'],receive:['Pickup plan','Vehicle details','Confirmed movement schedule'],uses:['Airport arrivals','Hotel-to-venue movement','Multi-stop groups'],related:'car-rental'},ar:{title:'التنقلات',lead:'تنقلات مرتبطة بمواعيد الرحلات ونقاط الاستلام وعدد المسافرين ونوع المركبة.',need:['رقم الرحلة وموعد الوصول','مواقع الاستلام والتوصيل','عدد المسافرين والحقائب','نوع المركبة أو متطلبات الوصول'],handle:['تنسيق السائق والمركبة','مواعيد المطار','ترتيب التوقفات','تسلسل حركة المجموعة'],receive:['خطة الاستقبال','تفاصيل المركبة','جدول تنقل مؤكد'],uses:['استقبال المطار','التنقل بين الفندق والفعالية','مجموعات متعددة التوقفات'],related:'car-rental'}},
  'car-rental':{en:{title:'Car Rental',lead:'Vehicle arrangements matched to pickup location, rental dates and traveler requirements.',need:['Pickup and drop-off','Rental dates','Vehicle category','Driver requirements'],handle:['Vehicle sourcing','Location and timing checks','Rental-term review','Booking confirmation'],receive:['Available vehicle options','Rental terms','Pickup confirmation'],uses:['Business trips','Longer stays','Independent regional travel'],related:'hotels-accommodation'},ar:{title:'تأجير السيارات',lead:'خيارات مركبات حسب موقع الاستلام ومدة الإيجار ومتطلبات المسافر.',need:['الاستلام والتسليم','تواريخ الإيجار','فئة المركبة','متطلبات السائق'],handle:['توفير الخيارات','مراجعة الموقع والموعد','مراجعة شروط الإيجار','تأكيد الحجز'],receive:['خيارات مركبات متاحة','شروط الإيجار','تأكيد الاستلام'],uses:['رحلات العمل','الإقامات الطويلة','التنقل المستقل'],related:'hotels-accommodation'}},
  'tours-experiences':{en:{title:'Tours & Experiences',lead:'Destination activities scheduled around the main itinerary, group size and preferred format.',need:['Destination and dates','Group size','Private or shared format','Available time in the itinerary'],handle:['Experience selection','Guide and timing coordination','Pickup alignment','Booking details'],receive:['Suitable activity options','Program timing','Confirmed experience details'],uses:['Private city visits','Group programs','Corporate itineraries'],related:'groups-special-requests'},ar:{title:'الجولات والتجارب',lead:'أنشطة في الوجهة مرتبة حسب برنامج الرحلة وعدد المشاركين ونوع التجربة.',need:['الوجهة والتواريخ','عدد المشاركين','خاص أو مشترك','الوقت المتاح في البرنامج'],handle:['اختيار التجربة','تنسيق المرشد والوقت','ربط موعد الاستلام','تفاصيل الحجز'],receive:['خيارات مناسبة','توقيت البرنامج','تفاصيل تجربة مؤكدة'],uses:['جولات خاصة','برامج مجموعات','رحلات شركات'],related:'groups-special-requests'}},
  'groups-special-requests':{en:{title:'Groups',lead:'Rooming, arrivals, transport and program timing managed as one connected operation.',need:['Passenger list','Arrival and departure schedule','Rooming requirements','Program and movement plan'],handle:['Room blocks','Arrival mapping','Vehicle allocation','Change and list follow-up'],receive:['Structured group plan','Aligned supplier details','Current booking status'],uses:['Leisure groups','Meetings and events','Multi-service programs'],related:'hotels-accommodation'},ar:{title:'المجموعات',lead:'الغرف والوصول والتنقلات ومواعيد البرنامج ضمن تشغيل واحد مترابط.',need:['قائمة المسافرين','مواعيد الوصول والمغادرة','توزيع الغرف','البرنامج وخطة التنقل'],handle:['حجز الغرف','ربط مواعيد الوصول','توزيع المركبات','متابعة القوائم والتعديلات'],receive:['خطة مجموعة مرتبة','تفاصيل موردين متناسقة','حالة حجز محدثة'],uses:['مجموعات سياحية','اجتماعات وفعاليات','برامج متعددة الخدمات'],related:'transfers'}},
  'corporate-travel':{en:{title:'Corporate Travel',lead:'Employee and executive travel arranged around policy, schedule and recurring business needs.',need:['Traveler and trip purpose','Policy requirements','Dates and routing','Hotel and flight preferences'],handle:['Policy-aware option review','Flight and hotel coordination','Repeated booking details','Schedule changes'],receive:['Relevant compliant options','Connected itinerary','Clear booking status'],uses:['Executive movement','Employee travel','Meetings and recurring routes'],related:'flights'},ar:{title:'سفر الشركات',lead:'سفر الموظفين والتنفيذيين حسب السياسة والمواعيد واحتياج العمل المتكرر.',need:['المسافر وسبب الرحلة','متطلبات السياسة','التواريخ وخط السير','تفضيلات السكن والطيران'],handle:['مراجعة الخيارات حسب السياسة','تنسيق الطيران والسكن','تفاصيل الحجوزات المتكررة','تعديلات المواعيد'],receive:['خيارات مناسبة للسياسة','برنامج مترابط','حالة حجز واضحة'],uses:['تنقل التنفيذيين','سفر الموظفين','الاجتماعات والمسارات المتكررة'],related:'hotels-accommodation'}},
  'hospitality-solutions':{en:{title:'Hospitality',lead:'Commercial discussion for hotels and hospitality businesses seeking relevant B2B travel relationships.',need:['Property profile','Target business relationship','Markets or segments of interest','Current commercial setup'],handle:['Relationship review','Distribution discussion','Commercial coordination','Operational contact structure'],receive:['A defined discussion scope','Clear next steps','Relevant relationship model'],uses:['Hotel representation discussions','B2B booking cooperation','Hospitality business development'],related:'corporate-travel'},ar:{title:'الضيافة',lead:'نقاش تجاري مع الفنادق ومنشآت الضيافة الباحثة عن علاقات مناسبة في قطاع السفر B2B.',need:['نبذة عن المنشأة','نوع العلاقة المطلوبة','الأسواق أو الشرائح المستهدفة','الوضع التجاري الحالي'],handle:['مراجعة العلاقة','نقاش التوزيع','التنسيق التجاري','تحديد التواصل التشغيلي'],receive:['نطاق نقاش محدد','خطوات تالية واضحة','نموذج علاقة مناسب'],uses:['نقاشات تمثيل الفنادق','تعاون حجوزات B2B','تطوير أعمال الضيافة'],related:'corporate-travel'}},
}
